...
async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    const client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect('mongodb+srv://ggoffaux:Equ!nox3s@cluster0.aysla.mongodb.net/meetups?retryWrites=true&w=majority');
    const db = client.db();
