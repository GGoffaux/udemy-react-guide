...
async function getStaticProps() {
  // fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://ggoffaux:Equ!nox3s@cluster0.aysla.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var pages = __webpack_exports__["default"] = (HomePage); // import { useEffect, useState } from "react";
